...
int main(int argc, char* argv[]) {
  ...
  switch (uperms) {
    ...
    case 7: newperms |= S_IRUSR | S_IXUSR | S_IWUSR; break;
    default:
  ...
  switch (operms) {
    ...
    case 7: newperms |= S_IROTH | S_IXOTH | S_IWOTH; break;
    default:
    (void)fprintf(stderr, "%s: illegal permission value\n", argv[0]);
    return EXIT_FAILURE;
  }
